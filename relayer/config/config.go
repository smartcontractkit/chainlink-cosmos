...
import (
	...
	"github.com/smartcontractkit/chainlink-cosmos/relayer/db"
)
...
func (c *Chain) SetDefaults() {
	...
	if c.FallbackGasPrice == nil {
		d := decimal.NewFromBigInt(defaultConfigSet.FallbackGasPrice.BigInt(), -sdkmath.LegacyPrecision)
...
func sdkDecFromDecimal(d *decimal.Decimal) sdkmath.LegacyDec {
	i := d.Shift(sdkmath.LegacyPrecision)
	return sdkmath.LegacyNewDecFromBigIntWithPrec(i.BigInt(), sdkmath.LegacyPrecision)
}
