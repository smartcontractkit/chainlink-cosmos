...
// DenomMetadata provides a mock function with given fields: ctx, denom
func (_m *ReaderWriter) DenomMetadata(ctx context.Context, denom string) (*banktypes.QueryDenomMetadataResponse, error) {
	...
	var r0 *banktypes.QueryDenomMetadataResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*banktypes.QueryDenomMetadataResponse, error)); ok {
		return rf(ctx, denom)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *banktypes.QueryDenomMetadataResponse); ok {
		r0 = rf(ctx, denom)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*banktypes.QueryDenomMetadataResponse)
		}
	}
