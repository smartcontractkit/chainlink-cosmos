...
type ModuleParams struct {
	...
	MinAnswer cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=min_answer,json=minAnswer,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_answer"`
	// highest answer the median of a report is allowed to be
	MaxAnswer cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,opt,name=max_answer,json=maxAnswer,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_answer"`
	// Fixed LINK reward for each observer
	LinkPerObservation cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=link_per_observation,json=linkPerObservation,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"link_per_observation"`
	// Fixed LINK reward for transmitter
	LinkPerTransmission cosmossdk_io_math.Int `protobuf:"bytes,5,opt,name=link_per_transmission,json=linkPerTransmission,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"link_per_transmission"`
	// Native denom for LINK coin in the bank keeper
...
type FeedProperties struct {
	...
	// lowest answer the median of a report is allowed to be
	MinAnswer cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,opt,name=min_answer,json=minAnswer,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"min_answer"`
	// highest answer the median of a report is allowed to be
	MaxAnswer cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=max_answer,json=maxAnswer,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"max_answer"`
	// Fixed LINK reward for each observer
	LinkPerObservation cosmossdk_io_math.Int `protobuf:"bytes,8,opt,name=link_per_observation,json=linkPerObservation,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"link_per_observation"`
	// Fixed LINK reward for transmitter
	LinkPerTransmission cosmossdk_io_math.Int `protobuf:"bytes,9,opt,name=link_per_transmission,json=linkPerTransmission,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"link_per_transmission"`
	// Enables unique reports
...
type Transmission struct {
	Answer                cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=answer,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"answer"`
...
type Report struct {
	...
	Observations          []cosmossdk_io_math.LegacyDec `protobuf:"bytes,3,rep,name=observations,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"observations"`
}
...
type EventAnswerUpdated struct {
	Current   cosmossdk_io_math.Int `protobuf:"bytes,1,opt,name=current,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"current"`
	RoundId   cosmossdk_io_math.Int `protobuf:"bytes,2,opt,name=round_id,json=roundId,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"round_id"`
...
type EventNewRound struct {
	RoundId cosmossdk_io_math.Int `protobuf:"bytes,1,opt,name=round_id,json=roundId,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"round_id"`
	// address of starter
...
type EventNewTransmission struct {
	...
	Answer                cosmossdk_io_math.LegacyDec   `protobuf:"bytes,3,opt,name=answer,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"answer"`
	...
	Observations          []cosmossdk_io_math.LegacyDec `protobuf:"bytes,6,rep,name=observations,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"observations"`
