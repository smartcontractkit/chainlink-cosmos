...
type MsgUpdateFeed struct {
	...
	LinkPerObservation *sdkmath.Int `protobuf:"bytes,5,opt,name=link_per_observation,json=linkPerObservation,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"link_per_observation,omitempty"`
	// Fixed LINK reward for transmitter
	LinkPerTransmission *sdkmath.Int `protobuf:"bytes,6,opt,name=link_per_transmission,json=linkPerTransmission,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"link_per_transmission,omitempty"`
