...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.2.2-0.20240729104119-94fa309055ef
	...
	github.com/smartcontractkit/chainlink/v2 v2.10.0-beta0.0.20240729150120-2a5c69d35cce
