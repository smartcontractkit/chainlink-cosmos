...
require (
	...
	github.com/smartcontractkit/chainlink/integration-tests v0.0.0-20240324190334-800abfa647f5
	github.com/smartcontractkit/chainlink/v2 v2.10.0-beta0.0.20240324190334-800abfa647f5
