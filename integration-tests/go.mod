...
require (
	...
	github.com/smartcontractkit/chainlink/deployment v0.0.0-20250121172542-e1f60142bd9a
	github.com/smartcontractkit/chainlink/v2 v2.19.0-ccip1.5.16-alpha.0
