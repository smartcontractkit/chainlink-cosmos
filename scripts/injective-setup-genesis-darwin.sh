...
# Follow injective installation instructions from https://docs.injective.network/develop/tools/injectived/install
# This file is downloaded from https://github.com/InjectiveLabs/injective-chain-releases/releases/download/v1.10.0-1679065799/darwin-amd64.zip
...
WASM_MNEMONIC="surround miss nominee dream gap cross assault thank captain prosper drop duty group candy wealth weather scale put"
